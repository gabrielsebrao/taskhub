  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <textarea
          data-cy="input-projeto-descricao"
          className="appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
          id="description"
          value={description}
      ...
      <div className="mb-4" data-cy="select-projeto-gerentes">
      ...
      <div className="mb-4" data-cy="select-projeto-membros">
        <label className="block text-gray-700 font-bold mb-2" htmlFor="members">
          Members
        </label>
        <Select
      ...
      <Button
        data-cy="botao-form-criar-projeto"
